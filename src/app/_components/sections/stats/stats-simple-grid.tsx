        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              ...
              >
                Unlock Engineering Excellence with Gambles
              </h2>
              <p
              ...
              >
                Join the future of innovation and development where bold ideas take shape in a conversational, dynamic environment.
              </p>
            </div>
            <dl
